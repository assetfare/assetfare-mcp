...
function validateHandoff(handoff) {
  ...
  // Mutual-exclusivity machine fields (one-of the two options); fail closed if any is missing or wrong.
  if (handoff.selection !== "choose_exactly_one" || handoff.mutually_exclusive !== true || handoff.do_not_call_both !== true || handoff.selection_before_signing !== true || handoff.once_any_action_submitted_do_not_start_other_mode !== true) throw new Error("assetfare_safety_boundary_failed");
