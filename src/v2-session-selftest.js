...
globalThis.fetch = async (url, init = {}) => {
  ...
  if (path === "/v2/session" && init.method === "POST") {
    ...
    const rec = { session_id: sessionId, token_hash: th, route, fingerprint: mark, status: "action_ready" };
