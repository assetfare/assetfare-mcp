...
assert.match(card.description,/direct_route_summary.*ordered provider.*direct_protocol_only.*external_intent.*route_aggregator_used=false/i);
assert.match(card.skills[0].description,/direct_route_summary.*ordered provider.*external_intent.*route_aggregator_used=false/i);
