...
assert.equal(packageMetadata.version, "1.5.2");
if(lockMetadata){assert.equal(lockMetadata.version, "1.5.2");assert.equal(lockMetadata.packages[""].version, "1.5.2");}
assert.equal(registryMetadata.version, "1.5.2");
if(bridgeRegistryMetadata)assert.equal(bridgeRegistryMetadata.version, "1.5.2");
...
try {
  ...
  assert.equal(card.serverInfo.version, "1.5.2");
