...
assert.equal(packageMetadata.version, "1.5.3");
if(lockMetadata){assert.equal(lockMetadata.version, "1.5.3");assert.equal(lockMetadata.packages[""].version, "1.5.3");}
assert.equal(registryMetadata.version, "1.5.3");
if(bridgeRegistryMetadata)assert.equal(bridgeRegistryMetadata.version, "1.5.3");
...
try {
  ...
  assert.equal(card.serverInfo.version, "1.5.3");
