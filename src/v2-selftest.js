...
assert.equal(lockMetadata.version, "0.4.6");
assert.equal(lockMetadata.packages[""].version, "0.4.6");
assert.equal(registryMetadata.version, "0.4.6");
...
try {
  ...
  assert.equal(card.serverInfo.version, "0.4.6");
