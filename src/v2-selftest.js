...
if(lockMetadata){assert.equal(lockMetadata.version, "1.5.0");assert.equal(lockMetadata.packages[""].version, "1.5.0");}
assert.equal(registryMetadata.version, "1.5.0");
if(bridgeRegistryMetadata)assert.equal(bridgeRegistryMetadata.version, "1.5.0");
