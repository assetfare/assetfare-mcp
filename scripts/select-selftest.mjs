...
try{
  ...
  console.log(JSON.stringify({status:"pass",network_requests:network,file_mode:"0600",multistep_session_only:true,hash_tamper_rejected:true,bounds_tamper_rejected:true,expired_rejected:true,server_signing:false,server_submission:false}));
